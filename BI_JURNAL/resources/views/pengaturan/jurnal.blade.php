                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="akreditasi_sinta" class="form-select">
                                    <option value="Blm_akreditasi">-- Pilih --</option>
                                    @for ($i = 1; $i <= 6; $i++)
                                        <option value="Sinta {{ $i }}">Sinta {{ $i }}</option>
                                    @endfor
                                    <option value="Blm_akreditasi">Blm_Akreditasi</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="scopus_index" class="form-select">
                                    <option value="Blm_scopus">-- Pilih --</option>
                                    @foreach (['Q1', 'Q2', 'Q3', 'Q4'] as $q)
                                        <option value="{{ $q }}">{{ $q }}</option>
                                    @endforeach
                                    <option value="Blm_scopus">Blm_Scopus</option>
                                </select>
                            </div>
                            <div class="col-md-6">
