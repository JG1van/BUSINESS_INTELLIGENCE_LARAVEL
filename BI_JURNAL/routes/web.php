...
use App\Http\Controllers\ImportJurnalController; // ✅ tambahkan ini
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware('auth')->prefix('pengaturan')->group(function () {
    ...
    Route::get('/import-jurnal', [ImportJurnalController::class, 'index'])->name('pengaturan.import-jurnal');
    Route::post('/import-jurnal', [ImportJurnalController::class, 'store'])->name('pengaturan.import-jurnal.store');
    Route::get('/pengaturan/import-jurnal', [ImportJurnalController::class, 'index'])
        ->name('pengaturan.import-jurnal');
